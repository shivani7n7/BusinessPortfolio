...
<body>
            ...
            <ul class="navbar-nav">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu">
                  <a class="dropdown-item active" href="WebDesigning.php">
                    web designing
                  </a>
  ...
  <!-- Start webDev Page breadcrump section -->
      ...
      <div class="row">
        <div class="col-12">
          ...
          <ol class="breadcrumb p-0">
            ...
            <li class="breadcrumb-item">Services</a></li>
  ...
  <!-- End webDev Page breadcrump section -->


  <!-- Start webDev Page 1st section -->
  <div class="container">
    <div class="row">
      <div class="col-md-9 px-5 p-4 text-justify ">
        <h5>
          About SEO Services -
        </h5>
        <p>
          Search engine optimization (SEO) is a critical component of online marketing. At SEO.com we use a combination
          of the latest onsite and off-site strategies to produce top results.

          Google processes billions of searches every day, and the vast majority of searchers never look beyond the
          first page. Do you know where your company ranks?
        </p>
        <p>
        ...
        <p>
          Most internet users begin their session by searching for something – that something is a need. People use the
          internet to fulfill their need for information, whether it’s settling a bet on who was the 14th president
          (Franklin Pierce, by the way) or finding a local restaurant, perfect piece of clothing, or the ideal
          contractor for a home remodel.
          Search engine optimization (SEO) is the process of helping your customers connect with your business online.
        </p>
        <p>
          Our team uses modern SEO services, backed by the best digital practices, to increase your traffic & rankings
          for vetted keywords and long-tail phrases that drive business to your site.
        </p>
      </div>

      <div class="col-md-3 p-4">
        <p class="p-4 text-center">
          <img class="img-fluid" src="images/seo/computer.png" width=150>
        </p>
        <p class="p-4 text-center">
          <img class="img-fluid" src="images/seo/search.png" width=150>
        </p>
      </div>
    </div>
  </div>
  <!-- End webDesigning Page 1st section -->

  <!-- Start webDesigning Page skill section -->
  <section>
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="bar p-2 m-2" style="background-color: #079992; width: 90%;">
            Google Adwords -90%
          </div>
          <div class="bar p-2 m-2" style="background-color: #b71540; width: 85%;">
            Facebook Ads -85%
          </div>
          <div class="bar p-2 m-2" style="background-color: #F97F51; width: 80%;">
            Instagram Ads -80%
  ...
  <!-- End webDesigning Page skill section -->

  <!-- Start webDesign Page Req Section  -->
  <section>
  ...
  <!-- End webDesign Page Req Section  -->
